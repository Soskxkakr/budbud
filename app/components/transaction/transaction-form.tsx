	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="sm:max-w-[525px]">
				...
				<div className="py-3 mb-4 border-b border-gray-200 bg-gray-50 -m-4 p-4 rounded-t-lg">
				...
				<div className="relative">
					...
					>
						<form onSubmit={() => {}} className="space-y-4 mx-1">
								...
								<Input
									...
									onChange={(e) => {
										...
										if (value === "" || /^\d*\.?\d{0,2}$/.test(value)) {
											setFormDetails((prev) => ({ ...prev, amount: value }));
										}
									}}
								/>
							</div>

							<Label className={cn(false && "text-destructive")}>Type</Label>
							<Select
								onValueChange={(value) =>
							...
							<div className="space-y-2 flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
